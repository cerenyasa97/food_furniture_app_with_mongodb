...
class AppConstants {
  ...
  static AppConstants get instance => _instance ??= AppConstants.init();

  AppConstants.init();

  String get mongoDbUrl =>
      'mongodb+srv://cerenyasa:123qwe@cluster0.iahiu.mongodb.net/food-furniture?retryWrites=true&w=majority';
